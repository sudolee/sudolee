...
/* sb read functions... */
extern inline void __raw_readsl(u32 addr, void *data, int len)
{
	u32 *buf = (u32 *)data;
	while(len--)
...
extern inline void __raw_readsw(u32 addr, void *data, int len)
{
	u16 *buf = (u16 *)data;
	while(len--)
...
extern inline void __raw_readsb(u32 addr, void *data, int len)
{
	u8 *buf = (u8 *)data;
	while(len--)
...
/* sb write functions... */
extern inline void __raw_writesl(u32 addr, void *data, int len)
{
	u32 *buf = (u32 *)data;
	while(len--)
...
extern inline void __raw_writesw(u32 addr, void *data, int len)
{
	u16 *buf = (u16 *)data;
	while(len--)
...
extern inline void __raw_writesb(u32 addr, void *data, int len)
{
	u8 *buf = (u8 *)data;
	while(len--)
